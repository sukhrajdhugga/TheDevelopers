<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddContractors.aspx.cs" Inherits="AddContractors" %>
...
<body>
    <form id="form1" runat="server">
       ...
       <div style="height:70px; width:85%;float:left;"> <div class="bannerdef">Contractor Details</div></div>
            </div>
    <div>
    
        <br />
        <div class="abc">
            <div class="def">Add Contractor</div>
